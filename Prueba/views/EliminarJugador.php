...
<body>
	<div class="col-sm-6 col-md-offset-3">
        ...
        <form action="../logic/Eliminar.php" method="post" role="form" id="formulario">
            <div id="form-group">
                <label for="Cedula"> Introduzca la cédula del jugador que desea eliminar: </label>
                <input type="number" class="form-control" name="Cedula" id="cedula" placeholder="Introduce la cédula" required="required"> 
            </div> 

            <div class="form-group"> <br>
                <input class="btn btn-lg btn-primary btn-block" type="submit" value="Eliminar Jugador"></a>
            </div>
        </form>
